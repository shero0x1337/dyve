...
import { Alert, Button, LinkButton, Card, Col, Input, List, Menu, Row, Slider } from "antd";
...
function App(props) {
  ...
  */
  ...
  const getFloorPrice = async () => {
    return axios.get(`https://api.reservoir.tools/oracle/collections/0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d/floor-ask/v1?kind=spot&currency=0x0000000000000000000000000000000000000000`,  {
      headers: {
        'Accept': '*/*',
  ...
  useEffect(async () => { 
      const resultPrice = await getFloorPrice()
      console.log("hello price is", resultPrice)
      setFloorPrice(resultPrice)
  }, [getFloorPrice])
      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route path="/exShortPage">
            <div style={{ width: 640, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
              <h1 style={{marginTop:90}} >Name of Project</h1>
              <h3>Highest Bid</h3>
          ...
          <Route path="/lend">
            <div style={{ width: 640, margin: "auto", marginTop: 32, paddingBottom: 32 }}>
              ...
              <div id="lendDiv" class="row">
              <div>
                  <img class="img-responsive" src="https://ipfs.io/ipfs/QmV7JEWPVgETvLP8TF9i88UX1y3MzuHwq1nDjzBZmNoruj" width="250" height="250"></img>
              </div>
              <div>
                <p> Doodles NFT # 301</p>
                <p> Premium: 0.15 ETH </p>
                <Slider defaultValue={34} disabled={false} max={100}/>
                <p> Collateral: 120 ETH</p>
